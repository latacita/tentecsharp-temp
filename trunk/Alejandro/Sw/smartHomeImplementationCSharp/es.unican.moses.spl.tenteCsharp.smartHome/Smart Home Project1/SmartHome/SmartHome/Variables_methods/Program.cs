...
namespace Program
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //pr.Item(1).ProjectItems.Item(2).Remove();
            //pr.Item(2).ProjectItems.AddFromDirectory("C:\\Users\\Iskander\\Desktop\\Smart Home Project1\\Smart Home Project1\\SmartHome\\BlindMng");
