...
namespace Unican.smartHome
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.smartHomeEditorFactoryId)]
	internal partial class smartHomeEditorFactory : smartHomeEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new smartHomeEditorFactory.
		/// </summary>
		public smartHomeEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class smartHomeEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected smartHomeEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new smartHomeDocData(this.ServiceProvider, typeof(smartHomeEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new smartHomeDocView(docData, this.ServiceProvider);
		}
	}
}
