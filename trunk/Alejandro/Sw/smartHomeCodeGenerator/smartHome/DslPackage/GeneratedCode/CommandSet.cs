...
namespace Unican.smartHome
{
	...
	/// </summary>
	internal partial class smartHomeCommandSet : smartHomeCommandSetBase
	{
		/// <summary>
		/// Constructs a new smartHomeCommandSet.
		/// </summary>
		public smartHomeCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class smartHomeCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new smartHomeCommandSetBase.
		/// </summary>
		protected smartHomeCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewsmartHomeExplorerCommand,
				typeof(smartHomeEditorFactory).GUID);
		...
		{
			smartHomeExplorerToolWindow explorer = this.smartHomeExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentsmartHomeDocData != null && this.CurrentsmartHomeDocData.Store != null)
			{
				this.CurrentsmartHomeDocData.ValidationController.Validate(this.CurrentsmartHomeDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentsmartHomeDocData != null && this.CurrentsmartHomeDocData.Store != null)
			{
				...
				this.CurrentsmartHomeDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected smartHomeDocData CurrentsmartHomeDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as smartHomeDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected smartHomeDocView CurrentsmartHomeDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as smartHomeDocView;
			}
		}
		...
		/// </summary>
		protected smartHomeExplorerToolWindow smartHomeExplorerToolWindow
		{
			get
			{
				smartHomeExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(smartHomeExplorerToolWindow), true) as smartHomeExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				smartHomeExplorerToolWindow explorerWindow = this.smartHomeExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class smartHomeClipboardCommandSet : smartHomeClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new smartHomeClipboardCommandSet.
		/// </summary>
		public smartHomeClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class smartHomeClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new smartHomeClipboardCommandSetBase.
		/// </summary>
		protected smartHomeClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
