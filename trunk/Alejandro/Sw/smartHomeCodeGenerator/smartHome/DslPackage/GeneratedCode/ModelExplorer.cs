...
namespace Unican.smartHome
{
	...
	/// </summary>
	internal partial class smartHomeExplorer : smartHomeExplorerBase
	{
		/// <summary>
		/// Constructs a new smartHomeExplorer.
		/// </summary>
		public smartHomeExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the smartHomeExplorerToolWindow.
	/// </summary>
	internal abstract class smartHomeExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new smartHomeExplorerBase.
		/// </summary>
		protected smartHomeExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.smartHomeExplorerMenu;
			}
		}
		...
		{
			get { return global::Unican.smartHome.SmartHome.DomainClassId; }
		}
