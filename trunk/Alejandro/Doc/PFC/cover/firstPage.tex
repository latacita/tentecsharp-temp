...
Título:           & {Desarrollo de una Línea de Productos Software para Automatización de Hogares usando Clases Parciales de C\#}\\%\thesistitle  \\
Title:            & {Development of a Software Product Line for Automated Houses using C\# Partial Classes} \\ %\englishtitle \\
\end{tabular}
