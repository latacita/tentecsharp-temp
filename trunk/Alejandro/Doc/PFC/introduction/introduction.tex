...
Cuando una empresa desarrolla un producto software para distintos usuarios, se presenta la problemática de las versiones y evolución relacionada con el producto. Esta situación puede provocar diferentes coyunturas:
\begin{enumerate}
...
\end{enumerate}
Esta situación no es exclusiva del desarrollo de software, también se encuentra presente en otros ámbitos industriales como la fabricación de coches, electrodomésticos, teléfonos...
...
La producción en serie no supone ningún problema para los desarrolladores de software, debido a que una aplicación puede ser clonada millones de veces sin ninguna dificultad. El problema que atañe al software es la personalización en serie(\emph{mass customization}, en inglés), con la cual se busca crear una infraestructura adecuada a partir de la cual se puedan derivar, tan automáticamente como sea posible, productos concretos pertenecientes a una familia de productos software. Una \emph{familia de productos software} es un conjunto de aplicaciones software similares, que por tanto comparten una serie de características comunes, pero que también presentan variaciones entre ellos.

Debido a todo lo citado anteriormente en los últimos 20 años ha surgido el término denominado \emph{ingeniería de líneas de productos software}\cite{pohl:2005} que pretende estandarizar los principios, fundamentos y técnicas que buscan alcanzar la personalización en serie de los productos software.
