...
Cuando se está desarrollando con líneas de productos software en muchas ocasiones es necesario modelar las características de una familia software, para ello existe una notación visual que se denomina diagramas de características y que es descrita en la siguiente sección.
...
Tras haber descompuesto el problema en sus diferentes características se ha modelado un diagrama de características representado en la figura \ref{back:fig:featureModel} con las peculiaridades anteriormente descritas.
\begin{figure}[!tb]
