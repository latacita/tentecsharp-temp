...
Una vez implementado todo el sistema base se han realizado una serie de test de prueba, que consisten en crear una serie de instancias del sistema para comprobar que tanto las plantas y habitaciones eran creadas, añadidas y mostradas correctamente.
