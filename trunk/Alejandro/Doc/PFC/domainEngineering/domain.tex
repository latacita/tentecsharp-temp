...
Como se ha podido observar en las iteraciones anteriores se sigue un procedimiento muy similar. Por lo tanto, un proceso casi idéntico al de las secciones anteriores se sigue para las características restantes, es decir, para
...
Tras realizar todas las iteraciones necesarias para implementar la ingeniería de dominio, se consigue tener un sistema donde las diferentes características en las cuales se descompone están encapsuladas en grupos de clases.
