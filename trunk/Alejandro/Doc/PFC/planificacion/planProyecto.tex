...
\subsection{Planificación para la Fase de Ingeniería de Aplicación}
...
\begin{enumerate}
	\item En primer lugar es necesario desarrollar un metamodelo, o gramática, para nuestro lenguaje de modelado.A continuación, usando las DSL Tools, se generará automática un \emph{plugin} para Visual Studio 2010 que permita la edición de dichos modelos. Este plugin permitirá la construcción de modelos de hogares inteligentes concretos que satisfagan las necesidades particulares de cada usuario.
	\item A continuación,  se desarrollarán los generadores de código para la composición automática de las diferentes características que deben integrar el software para un hogar concreto a partir de un modelo creado haciendo uso del \emph{plugin} para Visual Studio creado en el punto anterior.
	\item Con lo anterior, ya tenemos la infraestructura para derivar automáticamante productos concretos mediante la composición de características. Por tanto, el siguiente fase sería el despliegue de nuestro producto. En dicha fase se realizarán las siguientes actividades:
		\begin{enumerate}
			\item Se crearán instaladores que permitan utilizar todo lo construido hasta este momento en cualquier computador provisto del entorno Visual Studio 2010.
