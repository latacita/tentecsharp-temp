...
%% Perfería simplemente un grafo de dependencias.
%%========================================================================%%
Las etapas a realizar para la construcción de dicho DSL y su generador de código asociado, de acuerdo al proceso habitual de la ingeniería de lenguajes dirigidos por modelos~\cite{kleppe:2008}, son las que se enumeran a continuación, y se reflejan en la Figura~\ref{plan:fig:ganttApplication}:
