...
\item \emph{Presencia simulada:} Para evitar posibles robos, cuando los habitantes dejen la casa por un periodo largo de tiempo, la presencia de personas podrá ser simulada. Hay dos opciones(no exclusivas entre ellas):
    \begin{enumerate}
    \item Simulación de las luces: Las luces podrán ser apagadas/encendidas para simular presencia. Se usará un esquema semi-aleatorio, por ejemplo el esquema variará cada día acorde a unos parametros aleatorios, pero las luces no serán apagadas/encendidas sin sentido, serán encendidas más por la tarde/noche que durante el día.
    \item Simulación de persianas: Las persianas serán subidas y bajadas, acorde con un esquema semi-aleatorio.Por ejemplo,las persianas de los dormitorios principales serán bajadas por la noche y subidas por la mañana,y las otras habitaciones, algunas noches se bajarán y otras noches no.
    \end{enumerate}
\item \emph{Detección de incendios:} Si alguno de los sensores instalados por las habitaciones detecta un fuego, se procederá activar los aspersores de agua instalados en la habitación, además de activar la alarma de fuego.
\end{enumerate}
