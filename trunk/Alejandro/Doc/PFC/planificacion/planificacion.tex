...
Debido a que el proceso \emph{Feature Driven Development} está especialmente orientado para proyectos que se pueden descomponer fácilmente en características, se ha utilizado éste para llevar a cabo el desarrollo de este proyecto, ya que como muestra la figura \ref{plan:fig:gantt} las características y/o tareas a implementar se encuentran bien definidas.
\subsection{}
