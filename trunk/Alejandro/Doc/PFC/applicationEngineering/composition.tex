...
De acuerdo a la filosofía del lenguaje CaesarJ~\cite{aracic:2006}, para crear una configuración concreta, deberemos crear una nueva característica que represente al producto final y que herede de las características
seleccionadas. Por ejemplo, la Figura~\ref{domain:fig:mediator} muestra un ejemplo de un hogar inteligente para el cual se ha seleccionado el control inteligente de energía, pero nada relacionado con el control automático de persianas ni de luces.

\begin{figure}[!h]
 \centering
 \includegraphics[width=.87\linewidth]{applicationEngineering/images/configuration.eps} \\
 \caption{Configuración de un hogar inteligente con el control inteligente de energía seleccionado.}
