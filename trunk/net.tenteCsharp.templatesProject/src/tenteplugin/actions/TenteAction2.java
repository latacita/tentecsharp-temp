 ...
 */
public class TenteAction2 implements IWorkbenchWindowActionDelegate {
		...
		if(openFile!=null){
			...
			if(openDirDirectory!=null){
				...
				try{
					...
					out.write(WorkflowCreator.generateApplicationWorkflow(openFile,openDirDirectory));
					out.close();
				}catch(Exception e){
...
//					new NullProgressMonitor(), properties, slotContents);		
				...
				finalMessage.setMessage("Final Product Generated");
				finalMessage.open();
			}
		}
	}
