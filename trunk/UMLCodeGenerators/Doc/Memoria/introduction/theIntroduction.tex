...
El \emph{desarrollo software dirigido por modelos}, entre otros objetivos, pretende automatizar partes del proceso de desarrollo de un producto software mediante la automatización de ciertos pasos del mismo, ya sea mediante técnicas de análisis de modelos, simulación, transformación de un modelo en otro o generación de código desde los modelos. En el caso de las líneas de productos software, el desarrollo software dirigido por modelos se suele utilizar principalmente para automatizar el proceso de configuración o personalización de un producto concreto a partir de un conjunto común de elementos software reutilizables~\citep{sami:2010,pastor:2010}.
