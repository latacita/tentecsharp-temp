...
Para la derivación de productos concretos desde la infraestructura descrita en el párrafo anterior, TENTE usa un innovador lenguaje, denominado VML (\emph{Variability Management Language})~\citep{loughran:2008,sanchez:2008} para la especificación de las reglas que indican cómo se ha de configurar una arquitectura de referencia de acuerdo con la selección de características de cada cliente en particular.
...
\begin{enumerate}
	\item Gracias al uso de técnicas orientadas a características, como el operador \emph{merge} de UML y el lenguaje CaesarJ, se facilita la modularización y composición de características, lo que facilita no sólo el proceso de obtención de productos concretos, sino también la reutilización y evolución de dichas características~\citep{figueiredo:2008}.
