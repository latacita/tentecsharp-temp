...
EGL es un generador de código basado en plantillas. Dichas plantillas son similares a las utilizadas en la generación de páginas web dinámicas, al estilo de sistemas como JSP (\emph{Java Server Pages})~\cite{bergsten:2003} o PHP (\emph{PHP Hypertext Preprocessor})~\cite{mehdi:2013}.
