...
Tras implementar los generadores de código, el siguiente paso es realizar las pruebas que correspondan para poder comprobar el correcto funcionamiento de los generados de código implementados. Para ello se debían diseñar un conjunto de pruebas de forma sistemática, y ejecutar dicho conjunto de pruebas para verificar el correcto funcionamiento de los generadores de código creados. La Sección~\ref{domain:sec:pruebas} describe dicho proceso de diseño y ejecución de las pruebas.

Este capítulo describe este proceso de desarrollo. Más concretamente, la Sección~\ref{domain:sec:transf} describe las correspondencias definidas ente elementos UML 2.0 y elementos de C\#. La Sección~\ref{domain:sec:gen} describe la secuenciación de las plantillas de generación de código, mientras que la Sección~\ref{domain:sec:ejsencillo} muestra a modo de ejemplo, una sencilla plantilla de generación de código.
