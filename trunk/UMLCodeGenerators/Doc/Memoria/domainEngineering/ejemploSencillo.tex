...
24      if (oper.name==""){
25          methodname="method_"+iter;
26      }else{
27          methodname=oper.name;
28      }
29        opers=opers+oper.voidOperation(currentPackage, methodname, path); 
30      // Increase the iterator
31      iter=iter+1;
32  }
33  for (oper in operations_return) {
34      if (oper.name==""){
35          methodname="method_"+iter;
36      }else{
37          methodname=oper.name;
38      } 
39        opers=opers+oper.returnOperation(currentPackage, methodname, path);
40      // Increase the iterator
41      iter=iter+1;
42  }
43  return opers;
44 }\%]
