...
A continuación se procede al análisis más detallado de cada uno de los elementos descritos en las subsecciones anteriores, para ello nos apoyaremos en la Figura~\ref{dom:fig:ejemplo}.
...
Con esto queda explicado más detalladamente la transformación de modelo UML a código C\# descrita en esta Sección. En la siguiente sección se profundizará en la implementación y creación de las transformaciones de modelo UML a código C\#.
