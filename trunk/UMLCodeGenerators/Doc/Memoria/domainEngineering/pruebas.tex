...
03    assertLineWithMatch(path+"Data\\src\\BasicGraph\\Edge.cs", "partial class Edge");
04 } 
05 ...
06 @test
07 operation emptyPackage() {
08    assertEqualDirectories(path+"Data\\src\\PruebasBidireccionalidad\\PaqueteVacio",
                          path+"\\Data\\src\\PruebasBidireccionalidad\\PaqueteVacio");
09 }
10 ...
11 @test
12 operation thowsExceptions() {
13    ...
14    assertError(runTarget(pathTemplates+'\\Templates\\ParametersCreation.egl'));
15    ...
16 }
\end{lstlisting}
...
\hline
\multirow{14}{*}{Método} & Método con nombre. & \\
& Método sin nombre (se debe poner uno por defecto). &  \\
