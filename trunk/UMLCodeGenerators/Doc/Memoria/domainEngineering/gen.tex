...
\begin{figure}[!tb]
  \center
  \includegraphics[width=0.65\linewidth]{domainEngineering/images/PropertiesTemplates.eps} \\
...
Además, se crearon algunas \emph{Java Tool} para poder mostrar cuadros de diálogo que permitiesen interactuar con el usuario durante el proceso de generación de código, ya fuese para mostrarle o requerirle información.

\begin{figure}[!tb]
  \centering
  \includegraphics[width=.50\linewidth]{domainEngineering/images/SeleccionModelo.eps} \\
...
Las Figuras~\ref{dom:fig:modelos} y~\ref{dom:fig:final} muestran dos ejemplos de estos diálogos. El primero de ellos aparecería al utilizar como entrada para el generador de código un archivo UML que tuviese varios modelos. En este caso, el proceso de generación de código preguntaría al usuario cuál es el modelo a procesar, ya que dentro de un fichero UML pueden coexistir modelos de diversa índole.
