...
Las \emph{Líneas de Productos Software}~\citep{pohl:2010,kakola:2006} se han popularizado en la última década como un adecuado paradigma para el desarrollo, mantenimiento y gestión de proyectos software altamente similares. Por ejemplo, la arquitectura Partenón\footnote{http://www.isban.es/partenon.html} desarrollada por ISBAN, aporta un sistema bancario a las entidades de retail del Grupo Santander en Europa y Estados Unidos, que responde a la funcionalidad de los productos y servicios bancarios. Partenón es un Corebanking orientado al cliente que posibilita unificar el entorno operativo y de control, trasladando a las entidades una plataforma "de mejores prácticas" a nivel de registro, administración y seguimiento de operaciones. Proporciona una visión integrada de los clientes y sus posiciones en todos los canales. Además su aportación de servicios facilita la orientación a procesos de negocio (multicanal, multiidioma, multipaís, multientidad, comunicaciones a clientes,...), y proporciona además un catálogo de productos único y parametrizado, que permite una configuración sencilla de nuevos productos, lo que reduce el time to market. 

Si este proceso se realizara siguiendo un enfoque tradicional en el que cada producto solicitado es elaborado de forma específica e independiente del resto, el time to market y el coste de producción aumentarían drásticamente y llegaría el punto en el que el problema se haría inabarcable a la hora de compatibilizar los distintos productos y sus respectivas relaciones entre si. Por tanto, la finalidad de una línea de productos software es crear una infraestructura base común adecuada a partir de la cual se puedan derivar, tan automáticamente como sea posible, productos concretos pertenecientes a una familia de productos software.
...
Una vez definida la metodología TENTE, se decidió proceder a su transferencia tecnológica. Fue en este punto donde se encontró un obstáculo que en principio parecía insalvable. TENTE está basado en el uso del lenguaje CaesarJ como lenguaje de implementación, pero la mayor parte de las empresas del sector de desarrollo software se encuentran reticentes al cambio de su lenguaje habitual de programación debido fundamentalmente a dos motivos: (1) el coste de apredizaje por parte de sus programadores de los nuevos conceptos y técnicas de codificación y (2) el uso de un nuevo lenguaje podría dejar obsoletas muchas de las herramientas de la empresa como las suites para ejecución de pruebas.
