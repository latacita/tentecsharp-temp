...
El objetivo de la \emph{Línea de Producto Software} ~\cite{pohl:2010}, de un segmento particular de mercado, es reutilizar una base común de tecnología y proporcionar productos personalizados, acordes a las necesidades del cliente de manera eficiente, eficaz y a un coste razonable.
