...
Una \emph{clase virtual} es una clase perteneciente a una familia de clases y que es susceptible de ser heredada y sobreescrita por familias de clases, al estilo de los métodos virtuales de una clase en el paradigma orientado a objetos~\citep{}.
