...
Además, las referencias entre clases se actualizan automáticamente. Por ejemplo, en el caso de la figura~\ref{back:fig:smartHome}, aunque no se haga explícitamente, cualquier referencia a una clase del tipo \imp{Gateway} dentro de la familia de clases \imp{SmartEnergyMng} se referirá a la clase virtual \imp{Gateway} de la familia de clases \imp{SmartEnergyMng} y no a la clase virtual de mismo nombre de la familia de clases \imp{HeaterMng}. De esta forma, las referencias están siempre actualizadas a su versión más extendida.
