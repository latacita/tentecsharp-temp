public class EAttribute {
	// Attributes of the class EAttribute
  		public Property base_Property;    		
  		public EString attributeName;    		
  		public EBoolean isID;    		
    ...
    // Getters for each attribute of the class EAttribute
    	public Property getbase_Property () {
    		return base_Property;
  		}
    	public EString getattributeName () {
    		return attributeName;
  		}
    	public EBoolean getisID () {
    		return isID;
  		}
    ...
    // Setters for each attribute of the class EAttribute
    	public void setbase_Property (Property base_Property) {
   	 		this.base_Property = base_Property;
  		}  
    	public void setattributeName (EString attributeName) {
   	 		this.attributeName = attributeName;
  		}  
    	public void setisID (EBoolean isID) {
   	 		this.isID = isID;
  		}  
