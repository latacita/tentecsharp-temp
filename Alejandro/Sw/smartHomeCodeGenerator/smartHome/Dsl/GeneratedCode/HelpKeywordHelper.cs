...
namespace Unican.smartHome
{
	...
	/// </remarks>
	public partial class smartHomeHelpKeywordHelper : smartHomeHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new smartHomeHelpKeywordHelper.
		/// </summary>
		protected smartHomeHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the smartHomeHelpKeywordHelper.
		/// </summary>
		public static smartHomeHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class smartHomeHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new smartHomeHelpKeywordHelperBase.
		/// </summary>
		protected smartHomeHelpKeywordHelperBase()
			: base() { }
