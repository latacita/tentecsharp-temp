...
En ocasiones esta variabilidad presente en todos los casos estudiados anteriormente es representada mediante una notación visual denominada diagramas de características, por ello la siguiente sección describe la notación y peculiaridades de este tipo de diagramas.
% Qué hace esto aquí
...
\begin{figure}[!tb]
  \centering \includegraphics[width=.65\linewidth]{background/images/featureModelExpr.eps} \\
