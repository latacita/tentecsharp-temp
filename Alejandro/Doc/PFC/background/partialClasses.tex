...
En los siguientes capítulos, evaluaremos las ventajas e inconvenientes de las clases parciales de C\# como mecanismo para la implementación de una línea de productos software mediante la construcción de una línea de productos software de hogares inteligentes. El siguiente capítulo describe la planificación seguida para realizar dicho proyecto.
