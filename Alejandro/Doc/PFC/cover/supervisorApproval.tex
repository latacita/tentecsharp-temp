...
\begin{tabular}{lcr}
	...
	\ \ \ \ \ \ \ \ \ \ \ \
	&
	\includegraphics[width=0.10\linewidth]{images/uc.eps} \\
\end{tabular}
...
Certifica que D. Alejandro P{\'e}rez Ruiz, alumno de Ingeniería Informática, ha realizado en el Departamento de Matemáticas, Estadística y Computaci{\'o}n de la Universidad de Cantabria, bajo mi direcci{\'o}n, el Proyecto Fin de Carrera titulado:

\ \\ \ \\

\begin{center}
\emph{Desarrollo de una Línea de Productos Software para Automatización de Hogares usando Clases Parciales de C\#}
\end{center}
