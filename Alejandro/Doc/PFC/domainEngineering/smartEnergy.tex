...
Sección~\ref{domain:sec:pattern}. La implementación del método \imp{adustTemperature} se muestra en la Figura~\ref{}. 

%%=======================================================================================================%%
%% NOTA(Pablo): Poner aquí abreviado el método adjustTemperature de la clase Gateway de la               %%
