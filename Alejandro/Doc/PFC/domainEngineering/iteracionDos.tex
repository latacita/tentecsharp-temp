...
A continuación, tanto el diseño de la Figura~\ref{domain:fig:heaterMngDesign} como el de las interfaces mostradas en las Figuras~\ref{domain:fig:GUIHeaterMng} y~\ref{domain:fig:SimulatorHeaterMng}, se implementa usando los principios descritos en la Sección~\ref{domain:sec:pattern}. Por último, realizamos las pruebas de dicha implementación. Los 
casos de prueba ejecutados se describen a continuación:
